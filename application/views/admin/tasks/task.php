...
<?php //echo $rel_val['id']; echo $rel_val['name']; ?>
                                    </div>
            ...
            if ($(this).val() != '') {
                ...
                if (_rel_type.val() == 'lead'){
                    ...
                    function(response) {
                        ...
                        // headshot testing
                        // $('input[name="custom_fields[tasks][39]"]').val(response.address);
                        // $('input[name="custom_fields[tasks][40]"]').val(response.city);
                        
                        // Live
                        $('input[name="custom_fields[tasks][44]"]').val(response.address);
                        $('input[name="custom_fields[tasks][45]"]').val(response.city);
    ...
    function task_rel_select() {
        ...
        // console.log(serverData, "Lead Test");
