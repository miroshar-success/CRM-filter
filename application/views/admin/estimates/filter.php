...
<div class="panel_s">
    <div class="panel-body">
        <?php echo form_open($this->uri->uri_string() . ($this->input->get('filter_id') ? '?filter_id=' . $this->input->get('filter_id') : ''), "id=estimate_form_filter"); ?>
        <div class="_filters _hidden_inputs">
            <div class="row">
                <!-- start date time div -->
                <div class="col-md-2 form-group border-right" id="report-time">
                    <label for="months-report"><?php echo _l('estimate_data_date'); ?></label><br />
                ...
                <div id="date-range" class="col-md-4 <?php echo ($report_months != 'custom' ? 'hide' : '') ?> mbot15" id="date_by_wrapper">
                    <div class="row">
                        ...
                        <div class="col-md-6 border-right">
                            ...
                            <div class="input-group date">
                                <input type="text" class="form-control datepicker" id="report_to" name="report_to" autocomplete="off" onchange="dt_custom_view(this.value,'.table-estimates','report_to'); return false;">
                                <div class="input-group-addon">
                                    <i class="fa fa-calendar calendar-icon"></i>
                                </div>
                            </div>
                ...
                <div class="col-md-2 form-group border-right" id="report-time-valid">
                    <label for="months-report"><?php echo _l('estimate_data_expiry_date'); ?></label><br />
                ...
                <?php if (!empty($list_custom_field)) {
                    $cfs = get_custom_fields('estimate', "id in (" . implode(',', $list_custom_field) . ")");
                    foreach ($cfs as $cf) { ?>
                        <div class="col-md-2 border-right mbot15">
                            ...
                            echo render_select(
                                ...
                                array(
                                    ...
                                    'onchange' => "dt_custom_view(this.value,'.table-estimates','cf');return false;"
                                ),
                                array(),
                                'no-mbot',
                                '',
                ...
                <div class="col-md-2 text-center1 border-right">
                    ...
                    echo render_select(
                        ...
                        array(
                            ...
                            'multiple' => true,
                            'data-actions-box' => true,
                            'onchange' => "dt_custom_view(this.value,'.table-estimates','status'); return false;"
                        ),
                        array(),
                        'no-mbot',
                        'status',
