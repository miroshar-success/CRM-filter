...
<div class="row">
    <div class="col-md-12 section-client-dashboard">
        <h1 id="greeting" class="tw-mt-0"></h1>
        ...
        <div class="panel_s">
            <div class="panel-body">
                ...
                <?php foreach ($menu as $item_id => $item) { 
                    if (in_array($item_id, ['knowledge-base', 'invoices', 'contracts', 'proposals'])) {
                        continue;
                    }
                ?>
                    <li class="dashboard customers-nav-item-<?php echo $item_id; ?><?php echo $item['href'] === current_full_url() ? ' active' : ''; ?>"
    ...
    if (greet) {
        document.getElementById('greeting').innerHTML =
            '<span>' + greet + ' <?php echo $contact->firstname; ?> <?php echo $contact->lastname; ?>,<br/></span> in <b>My Leaseway</b>';
    }
    </script>